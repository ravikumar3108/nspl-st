...
// // // String :- string are used to store character values.
// // // works on index number
// // // whitespaces also countable.

// // let x = "my name is aashu name";
// // console.log(x);

// // console.log(x[4]);

// // // x[4] = "kdkd" // not supported
// // console.log(x.length);

// // // methods
// // // let n = x.replace("name","myname")
// // let n = x.replaceAll("name", "myname");
// // console.log(n);

// // // concat
// // let str = "My Age is...            ";
// // let con = str.concat(x);
// // console.log(con);
...
// // let lower1 = str.toUpperCase();
// // console.log(lower);
// // console.log(lower1);

// // // whitespaces remove left and right
...
// // Parameter ;- that value declare into the function create parenthesis
// // Arguments :- that value declare into the function calling parenthessis
...
// // Default parameters : this is always declare into the last.
// function Defa(a, b = 20, c = 0) {
//   console.log(a * b + c);
// }
...
// DOm :- document object model with the help of we can access the elements and make methods like change, aceess , delete , append , styling.
// access the elements :-
...
div.innerHTML = "My namei is Aashu";

let cldiv = (document.getElementsByClassName("maindiv")[1].innerHTML = "Div 2");

// Create elements :-

let divCreate = document.getElementById("create");
let ch = document.createElement("h1");
divCreate.appendChild(ch);
// divCreate.removeChild(ch)

ch.setAttribute("class", "head");
ch.setAttribute("id", "heading");
